    ...
    <>
      <div className="m-11">
        <div className="bg-white rounded-lg m-8 p-8 flex flex-col items-center">
          <img
            ...
            width={700}
            height={250}
            className="border-8 rounded-lg m-8"
          ></img>
          <Link
          ...
          <p className="border-4 rounded-md w-1/2 text-lg m-5 p-5 ">
            A full stack pizza ordering application that enables users to
            explore a menu of pizzas, select items for their cart, and place
            orders seamlessly. Key features include user account creation,
            secure login with authentication, cart management for adding pizzas,
        ...
        <p className="border-4 rounded-md w-auto text-lg m-5 p-5 ">
          A full stack pizza ordering application that enables users to explore
          a menu of pizzas, select items for their cart, and place orders
          seamlessly. Key features include user account creation, secure login
          with authentication, cart management for adding pizzas, and a
      ...
      <div className="w-full px-6 lg:px-2">
        ...
        <div className="card card-side bg-base-100 shadow-xl">
          <figure>
            <img src={sliceOverflowImage} alt="Movie" />
          </figure>
          <div className="card-body flex flex-col justify-center items-center text-center">
            {" "}
            {/* Added flex, justify-center, and items-center */}
